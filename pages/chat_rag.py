...
from functions.rag_mlh import read_doc, chunk_text_for_list, generate_embeddings, generate_short_id, combine_vector_and_text, upsert_data_to_pinecone, get_query_embeddings, query_pinecone_index, generate_answer 
...
if st.button("Embeddings and process in pinecone"):
    ...
    st.success("Please click on the button to start processing")
